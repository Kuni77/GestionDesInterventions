...
<head>
	<meta charset="UTF-8">
	<title>Intervention Urgent</title>
	<link rel="stylesheet" type="text/css" href="css/bootstrap.min.css">
	<link rel="stylesheet" type="text/css" href="css/fonts/font-awesome.min.css">
	<link rel="stylesheet" type="text/css" href="css/styleaccueil.css">
	<link rel="stylesheet" type="text/css" href="css/don - Copie.css">
	<link rel="stylesheet" type="text/css" href="css/intervention-urgent.css">
...
<body>
	...
	<div class="row">
       	<div class="col-sm-9 col-md-11 col-lg-11 col-xl-11"><span class="type-urgent">Urgent</span></div>
       	<div class="col-sm-3 col-md-1 col-lg-1 col-xl-1">
       		<form method="post" action="urgent">
