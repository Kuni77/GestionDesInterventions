...
@WebServlet("/InterventionPasUrgent")
public class InterventionPasUrgent extends HttpServlet 
{
	private static final long serialVersionUID = 1L;
	public static final String VUE = "/WEB-INF/intervention-pas-urgent.jsp";
	...
	{
		ListeIntervention liste=cdpd.listerIntervention("Pas-Urgent");
